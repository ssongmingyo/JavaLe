...
public class _05_InfiniteWhile {
	...
	public static void main(String[] args) {
		...
		// System: 현재 사용 중인 운영체제의 정보를 가져오는 클래스
		// System.in: 현재 사용 중인 운영체제의 입력장치, 키보드, 마우스
		...
		// 무한루프 구문
				...
				// Scanner.nextLine(): 입력받은 문자열을 리턴해주는 메소드. 엔터값을 포함한 묹열을 리턴. 
				...
				// String.equalsIgnoreCase(): 대소문자 구분없이 값비교
